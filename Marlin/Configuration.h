...
#define STRING_CONFIG_H_AUTHOR "(codeman256, Ender-5 Plus, SKR1.4Turbo)" // Who made the changes.
...
// Choose the name from boards.h that matches your setup
  ...
  #define MOTHERBOARD BOARD_BTT_SKR_V1_4_TURRBO
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "J&R Ender-5 Plus"
